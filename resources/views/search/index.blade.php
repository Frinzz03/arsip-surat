        ...
        <div class="glass-card p-6 mb-8 border-t-4 border-sky-500">
            <form method="GET" action="{{ route('search.results') }}">
                ...
                <div class="mt-6 flex gap-3">
                    ...
                    @if(request()->hasAny(['keyword', 'kode_surat', 'pengirim', 'sifat', 'tanggal_dari', 'tanggal_sampai']))
                            ...
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1">
                                    <h4 class="font-semibold text-sky-700 dark:text-sky-400 text-lg">
                                        <a href="{{ route('surat-masuk.show', $surat) }}" class="hover:underline">{{ $surat->kode_surat }}</a>
                                    </h4>
